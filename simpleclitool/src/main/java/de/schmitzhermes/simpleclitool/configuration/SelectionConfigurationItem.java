...
public class SelectionConfigurationItem<T> extends ConfigurationItem<T> {
    ...
    public SelectionConfigurationItem(Integer argNumber, String optionName, String question, Class<?> itemClass, T defaultValue, SelectionContent<T> content, Configuration config) {
